...
#     kubler.sh build -i niyaton/dev-base
# ..and then search the Portage database:
#     eix <search-string>
_packages="app-editors/vim app-misc/tmux app-shells/zsh dev-vcs/git"
...
finish_rootfs_build()
{
    ...
    #export DISTRIBUTION_DIR="${GOPATH}/src/github.com/niyaton/dev-base"
    #mkdir -p "${DISTRIBUTION_DIR}"

    #git clone https://github.com/niyaton/dev-base.git "${DISTRIBUTION_DIR}"
    #cd "${DISTRIBUTION_DIR}"
    #git checkout tags/v${_dev-base_version}
    #echo "building dev-base ${_dev-base_version}.."
    ...
    #log_as_installed "manual install" "dev-base-${_dev-base_version}" "https://dev-base.org/"
    :
}
